...
class AnalysisTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.btn_search.setToolTip("搜索股票代码/名称")
        self.btn_search.setMaximumWidth(36)
        self.btn_search.clicked.connect(self._open_stock_search)
    ...
    def _open_stock_search(self) -> None:
        ...
        dlg.selected.connect(lambda ticker: self.input.setText(ticker))
        dlg.exec()
